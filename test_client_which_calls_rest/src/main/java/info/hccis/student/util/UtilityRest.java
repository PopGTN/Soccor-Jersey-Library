...
public class UtilityRest {
    ...
    public static Object addUsingRest(String urlIn, Object objectIn) {
         ...
         * @author BJM
         */
    public static void updateUsingRest(String urlIn, Object objectIn) {
        //**********************************
        //Create a test camper
        //**********************************
...
//                Object camperReturned = gson.fromJson(content, objectIn.getClass());
    ...
    public static void deleteUsingRest(String urlIn, int id) {
        ...
        try {
            ...
            if (conn.getResponseCode() != HttpURLConnection.HTTP_OK) {
                ...
                System.out.println("Success : Delete a Jersey (" + id + ")\n");
            }
            conn.disconnect();
        } catch (MalformedURLException e) {
            e.printStackTrace();
